 ...
 * Version 2012-03-09
 *
 * This code was placed in the public domain by its original author, Stefan Gustavson. You may use
 * it as you see fit, but attribution is appreciated.
 *
 */
...
public class SimplexNoise
{
    ...
    private static short p_supply[] = {151, 160, 137, 91, 90, 15, // this contains all the numbers between 0 and 255, these are put in a random order depending upon
                                                                  // the seed
    ...
    public SimplexNoise(int seed)
    {
        ...
        // the seed determines the swaps that occur between the default order and the order we're actually
        // going to use
